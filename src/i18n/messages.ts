...
const messages = {
  it: {
    ...
    footerB2B: 'B2B',
    footerWholesale: "Acquisto all'ingrosso",
    ...
    legalCompanyLine: 'PartsPro S.r.l. - dati aziendali in verifica prima del go-live',
    legalComplianceLine: 'VAT, GDPR, Cookie, RMA e sicurezza batterie saranno confermati prima del go-live.',
  ...
  zh: {
    ...
    footerTagRma: '可追踪售后',
    legalCompanyLine: 'PartsPro S.r.l. - 公司资料上线前核验中',
    legalComplianceLine: 'VAT、GDPR、Cookie、RMA 和电池安全信息上线前确认。',
