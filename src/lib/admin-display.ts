...
const rawStatusLabels = {
  ...
  permission: {
    ...
    "orders:read": entry("查看订单", "Legge ordini", "blue"),
    "orders:write": entry("处理订单", "Gestisce ordini", "blue"),
    "customers:read": entry("查看客户", "Legge clienti", "blue"),
    "customers:write": entry("维护客户", "Modifica clienti", "blue"),
    "inventory:read": entry("查看库存", "Legge inventario", "green"),
    "inventory:write": entry("维护库存", "Modifica stock", "green"),
    "products:read": entry("查看商品", "Legge prodotti", "green"),
    "products:write": entry("维护商品", "Modifica prodotti", "green"),
    "finance:read": entry("查看财务", "Legge finanza", "amber"),
    "finance:write": entry("处理财务", "Modifica finanza", "amber"),
    "staff:read": entry("查看员工", "Legge staff", "violet"),
    "staff:write": entry("维护员工权限", "Modifica staff", "violet"),
    "settings:read": entry("查看设置", "Legge impostazioni", "slate"),
    "settings:write": entry("维护设置", "Modifica impostazioni", "slate"),
